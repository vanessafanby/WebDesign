...
Through the process of playtesting in Unity, I discovered several navigation difficulties and interaction problems. Such as moving through paths in the environment, and having problems of walking on bridges (too narrow). At first, my environment was a little too large, therefore I had to shrink the paths by adding more trees and buildings. Additionally, the feedback given from my piers allowed me change unclear paths, sounds and layouts, making my final project more clear, engaging and enjoyable. 
...
# Design thoughts 
For the design of my webpage, I aim to keep it clean and united. Such as, using easy colour palettes, and keeping the design modern and sharp. Furtheremore, I also want to include a menu bar or some clickable icons that can navigate the audience to each content on the website. 
